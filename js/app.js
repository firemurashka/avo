(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".slider-cart__body")) new core(".slider-cart__body", {
            ...
            pagination: {
                el: ".slider-cart__dotts",
                clickable: true
            },
            navigation: {
                nextEl: ".slider-cart .slider-arrow_next",
                prevEl: ".slider-cart .slider-arrow_prev"
            }
        });
    }
